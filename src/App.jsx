...
const experienceExampleData = [
  {
    ...
    description:
      "Led a diverse crew across the Grand Line in search of the One Piece. Defeated warlords, emperors, and inspired global change.",
  },
  {
    key: crypto.randomUUID(),
    ...
    location: "Baltigo",
    description:
      "Assisted in coordinating minor liberation efforts and distributed meat supplies to allies. Learned the basics of world politics.",
  },
  {
    key: crypto.randomUUID(),
    company: "Impel Down",
    ...
    location: "Calm Belt",
    description:
      "Orchestrated a high-profile prison breakout. Successfully navigated multiple levels of danger with minimal crew loss.",
  },
];
    ...
    <>
      <div className="left">
        ...
        <ExpandToggle title="General Information">
          <GeneralEditor info={generalInfo} setInfo={setGeneralInfo} />
        </ExpandToggle>
        <ExpandToggle title="Education">
          <EducationEditor info={educationInfo} setInfo={setEducationInfo} />
        </ExpandToggle>
        <ExpandToggle title="Experience">
          <ExperienceEditor info={experienceInfo} setInfo={setExperienceInfo} />
        </ExpandToggle>
      </div>
      <div className="right">
        <div ref={targetRef}>
